...
<html>
    ...
    <body>
        ...
        <form class="myform" action="form4.php" method="POST">
        ...
        if(isset($_POST['submit_form'])){ 
            ...
            $query="INSERT INTO form (title,descriptions,question1,question2,question3,question4)
            values('$title','$description','$question1','$question2','$question3','$question4')";
            $query_run=mysqli_query($con,$query);
