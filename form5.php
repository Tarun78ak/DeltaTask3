...
<html>
    ...
    <body>
        ...
        <form class="myform" action="form5.php" method="POST">
        ...
        <input name="qfour" class="inputvalues" placeholder="Write the question" type="text" required><br>
        <label>Question 5</label><br>
        <input name="qfive" class="inputvalues" placeholder="Write the question" type="text" required><br>
        ...
        if(isset($_POST['submit_form'])){ 
            ...
            $question4=$_POST['qfour'];
            $question5=$_POST['qfive'];
            ...
            $query="INSERT INTO form (title,descriptions,question1,question2,question3,question4,question5)
            values('$title','$description','$question1','$question2','$question3','$question4','$question5')";
            $query_run=mysqli_query($con,$query);
